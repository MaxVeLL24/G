...
// restore wishlist to sesssion
            if(!empty($wishList) && is_object($wishList))
            {
...
// ICW - CREDIT CLASS CODE BLOCK ADDED  ******************************************************* END
            ...
            $leo_text = 'Привет админам! <br>Это письмо сгенерировано автоматически и сообщает Вам о том, что в Вашем магазине стало на одного пользователя больше.<br> Имя нового пользователя: <font color="#263A73"><b>' . $lastname . ' ' . $firstname . '</b></font>.';
