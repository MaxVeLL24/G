...
// HMCS: Begin Autologon	**********************************************************
        if(tep_not_null($HTTP_COOKIE_VARS['email_address']))
        {   //Does email address exist in Cookie?
...
// reset the session variables
        ...
        $messageStack->add_session(CONTENT_ACCOUNT_EDIT, SUCCESS_ACCOUNT_UPDATED, 'success');
