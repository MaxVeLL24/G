<?php 
  if ($error == true) {
    echo 'ниодного товара не найдено';
  }
  else {
?>
    <div>
...
// create column list
  ...
  $column_list = array();
  $select_column_list = 'p.products_model, m.manufacturers_name, p.products_images, p.products_weight,';

  $select_str = "select distinct " . $select_column_list . " p.products_quantity, m.manufacturers_id, p.products_id, pd.products_name, p.products_price, p.products_tax_class_id, IF(s.status, s.specials_new_products_price, NULL) as specials_new_products_price, IF(s.status, s.specials_new_products_price, p.products_price) as final_price ";
