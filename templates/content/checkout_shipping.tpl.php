...
?>
      <tr>
        <td><table style="border:1px solid #a6a6a6" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="310" cellspacing="0" cellpadding="2">
              <tr>
                
                
                <td align="left" width="310" valign="top"><table border="0"  width="200" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="left" valign="top"><?php echo '<b>' . TITLE_SHIPPING_ADDRESS . '</b><br>' ?></td>
                  </tr>
                  <tr>
                ...
                <td class="main" width="50%" valign="top">
                  <table border="0" width="100" cellspacing="1" cellpadding="2" class="infoBox" align="left">
                   <tr class="infoBoxContents">
                    <td>
                    <table border="0" width="300" cellspacing="0" cellpadding="0">
                     <tr>
                      <td class="main"><b>Информация по доставке:</b><br><?php echo tep_draw_textarea_field('comments', 'soft', '129', '5'); ?></td>
                     </tr>
                    </table></td>
                   </tr>
                  </table>
...
?>
      <tr>
        <td><table border="0" width="250" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
<?php
...
?>
              <tr>
                ...
                <td class="main" width="240" valign="top"><b><?php echo TEXT_CHOOSE_SHIPPING_METHOD; ?></b></td>
                <td class="main" width="50" valign="top" align="left"><?php echo tep_image(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/content/arrow_east_south.gif'); ?></td>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '1'); ?></td>
              </tr>
<?php
...
?>
                    <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                    <td class="main" width="75%" colspan="2"><?php echo $quotes[$i]['methods'][$j]['title']; ?></td>
<?php
            if ( ($n > 1) || ($n2 > 1) ) {
?>
                    <td class="main" width="4000"><?php echo $currencies->format(tep_add_tax($quotes[$i]['methods'][$j]['cost'], (isset($quotes[$i]['tax']) ? $quotes[$i]['tax'] : 0))); ?></td>
