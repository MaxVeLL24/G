...
?>
              <tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td colspan="2"><table border="0" width="600" cellspacing="0" cellpadding="2">
<?php
...
?>
                    ...
                    <td width="300"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                  </tr>
<?php
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="infoBoxContents">Информация по доставке:<br>
<?php echo tep_draw_textarea_field('comments', 'soft', '63', '3'); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
