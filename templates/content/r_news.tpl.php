...
$do_we_have_categories_query2 = tep_db_query("select c.categories_id, cd.categories_name, c.parent_id from " . TABLE_NEWSDESK_CATEGORIES . " c, " 
...
$newsdesk_check2 = tep_db_num_rows($do_we_have_categories_query2);
if ($newsdesk_check2 > 0) {
