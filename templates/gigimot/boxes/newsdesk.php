...
for ($a=1; $a<$foo_newdesk[$counter]['level']; $a++) {
	$categories_newsdesk_string .= "&nbsp;&nbsp;";
}

$categories_newsdesk_string .= '<a class="punkt_news" href="';
...
if (SHOW_COUNTS == 'true') {
	...
	if ($products_newsdesk_in_category > 0) {
		$categories_newsdesk_string .= '<span class="count_news">&nbsp;' . $products_newsdesk_in_category . '</span>';
	}
}
