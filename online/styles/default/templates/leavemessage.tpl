	...
	<div id="content-wrapper">
		...
		<table cellspacing="1" cellpadding="5" border="0" class="form">
			<tr>
				...
				<td><input type="text" name="email" size="50" value="${form:email}" placeholder="${msg:errors.required}" class="username"/></td>
			</tr>
			<tr>
				<td><strong>${msg:form.field.name}:</strong></td>
				<td><input type="text" name="name" size="50" value="${form:name}" placeholder="${msg:errors.required}" class="username"/></td>
			</tr>
			<tr>
				<td><strong>${msg:form.field.message}:</strong></td>
				<td valign="top">
					<textarea name="message" placeholder="${msg:errors.required}" tabindex="0" cols="40" rows="5">${form:message}</textarea>
				</td>
			</tr>
			${else:errors}
			<table cellspacing="1" cellpadding="5" border="0" class="form">
