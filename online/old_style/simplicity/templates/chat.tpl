		...
		<tr>
			...
			<td width="100" valign="top">
				<table cellspacing="0" cellpadding="0" border="0" id="postmessage">
               		<tr>
                    	<td class="submit">
                			<a id="sndmessagelnk" style="background: #fff;padding: 10px;box-shadow: 0 0 3px #000;display: block;text-align: center;text-decoration: none;" href="javascript:void(0)" onClick="return false;" title="${msg:chat.window.send_message}">
                			${msg:chat.window.send_message}
                			</a>
						</td>
                	</tr>
            	</table>
