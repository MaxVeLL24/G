...
<div id="whitebg">
	<form name="leaveMessageForm" method="post" action="${mibewroot}/leavemessage.php">
		...
		<table cellpadding="0" cellspacing="5" border="0" width="100%">
			<tr>
				<td><img src = "/online/styles/simplicity/images/logo_online.png"></td>
				<td colspan="2">
			...
			<tr>
				<td>
					<table cellspacing="3" cellpadding="0" border="0">
						<tr>
							<td><a href="javascript:document.leaveMessageForm.submit();" title="${msg:leavemessage.perform}"><img src="${tplroot}/images/buttons/exec.png" border="0" alt="${msg:leavemessage.perform}"/></a></td>
