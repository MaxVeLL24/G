...
pd WHERE pd.newsdesk_id = p.newsdesk_id and pd.language_id = "' . $languages_id . '" and newsdesk_status = 1 and p.newsdesk_sticky = 0 ORDER BY newsdesk_date_added DESC LIMIT ' . 10);
...
$insert_date = '&nbsp;- ' . tep_date_long($newsdesk_var['newsdesk_date_added']) . '';
}
...
<table border="0" width="100%" cellspacing="3" cellpadding="0" style="border-bottom: 1px dashed #C8D9F7">
	<tr>
		<td valign="top" width="">
...
<table border="0" width="100%" cellspacing="3" cellpadding="0">
	...
	<tr>
		<td class="smallText" align="right">' . $insert_readmore . '</td>
