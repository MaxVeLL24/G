<?php
// raid - запрет входа не через админку
...
#branding { background: url('../includes/commentit/im/admin/branding_bg.png') repeat-x scroll center top rgb(29, 54, 82); min-height: 80px;color:#CCC;font-size:24pt;}
#primary_nav { background: url('../includes/commentit/im/admin/primarynav_bg.png') no-repeat scroll 0% 0% rgb(25, 43, 64); font-size: 0.95em; border-bottom: 5px solid rgb(82, 143, 108); padding-left: 10px; height: 31px; }
...
#primary_nav ul li.active { background: url('../includes/commentit/im/admin/tab_left.png') no-repeat scroll left top transparent; font-size: 1.05em; font-weight: bold; padding: 0pt; margin: -4px 0px auto 5px; position: relative; }
#primary_nav ul li.active a { background: url('../includes/commentit/im/admin/tab_right.png') no-repeat scroll right top transparent; padding: 10px 15px 10px 10px; margin-left: 6px; display: block; }
#primary_nav ul li a {color:#FFF;text-decoration: none; }
ol, ul { list-style: none outside none; }
#footer_utilities { background: url('../includes/commentit/im/admin/gradient_bg.png') repeat-x scroll 50% 50% rgb(25, 43, 64); color: rgb(255, 255, 255); font-size: 1.05em; min-height: 40px; }
...
Комментарии
<?php  //echo $langcommentit['admin_title']; ?>
</div>
</div>
<?php
function delempty()
...
echo '<div style="margin-left:'.$commentpx.'px;'.$spsstyle.'"><a class="nav" href="comments.php?treeview='.$idcom.'">'.$spsdownlevel.' <span style="font-size:6pt;color:#666;">'.$date.'</span><br /><b>'.$names.'</b> '.$comment_msg.' '.$warningmoder.' </a></div>';
echo "\r\n";
...
<div style="position:absolute; z-index:51; display:none;width:72px;background-color:#F0F0F0;" id="smilebar"><a href="javascript: put_smile(':)');"><img src="/$wwp/../includes/commentit/im/sml_1.gif" border="0" alt=" :)" title=" :)"  /></a>
<a href="javascript: put_smile('!;)');"><img src="/$wwp/../includes/commentit/im/sml_2.gif" border="0" alt="  ;)" title=" ;) " /></a>
<a href="javascript: put_smile(':D');"><img src="/$wwp/../includes/commentit/im/sml_3.gif" border="0" alt=" :D " title=" :D " /></a><br />
<a href="javascript: put_smile(':(');"><img src="/$wwp/../includes/commentit/im/sml_6.gif" border="0" alt=" :( " title=" :( " /></a>
<a href="javascript: put_smile('=)');"><img src="/$wwp/../includes/commentit/im/sml_4.gif" border="0" alt=" =) " title=" =) " /></a>
<a href="javascript: put_smile('?)');"><img src="/$wwp/../includes/commentit/im/sml_5.gif" border="0" alt=" ?) " title=" ?)"  /></a><br />
<a href="javascript: put_smile(':ups:');"><img src="/$wwp/../includes/commentit/im/sml_7.gif" border="0" alt=" :ups: " title=" :ups: " /></a>
<a href="javascript: put_smile(':cool:');"><img src="/$wwp/../includes/commentit/im/sml_8.gif" border="0" alt=" :cool: " title=" :cool: " /></a>
<a href="javascript: put_smile(':bad:');"><img src="/$wwp/../includes/commentit/im/sml_9.gif" border="0" alt=" :bad: " title=" :bad: " /></a><br />
<a href="javascript: put_smile(':like:');"><img src="/$wwp/../includes/commentit/im/sml_10.gif" border="0" alt=" :like: " title=" :like: " /></a>
<a href="javascript: put_smile(':angel:');"><img src="/$wwp/../includes/commentit/im/sml_11.gif" border="0" alt=" :angel: " title=" :angel: " /></a>
<a href="javascript: put_smile(':love:');"><img src="/$wwp/../includes/commentit/im/sml_12.gif" border="0" alt=" :love: " title=" :love: " /></a></div>
</div>
EOF;
}
...
<<<EOF
<style>
a.pic {background-image: url(/$wwp/../includes/commentit/im/bbbold.gif);width: 24px;height: 23px;display: block;float:left;}
a:hover.pic {background-position: 0 23px;}
a.pic2 {background-image: url(/$wwp/../includes/commentit/im/bbitalic.gif);background-position: 0 0;width: 23px;height: 23px;display: block;float:left;}
a:hover.pic2 {background-position: 0 23px;}
a.pic3 {background-image: url(/$wwp/../includes/commentit/im/bbunderlin.gif);background-position: 0 0;width: 24px;height: 23px;display: block;float:left;}
a:hover.pic3 {background-position: 0 23px;}
a.pic4 {background-image: url(/$wwp/../includes/commentit/im/bburl.gif);background-position: 0 0;width: 21px;height: 23px;display: block;float:left; margin:0 3px 0 3px;}
a:hover.pic4 {background-position: 0 23px;}
a.pic5 {background-image: url(/$wwp/../includes/commentit/im/bbimage.gif);background-position: 0 0;width: 21px;height: 23px;display: block;float:left;margin:0 3px 0 3px;}
a:hover.pic5 {background-position: 0 23px;}
a.pic8 {background-image: url(/$wwp/../includes/commentit/im/bbstrike.gif);background-position: 0 0;width: 23px;height: 23px;display: block;float:left;}
a:hover.pic8 {background-position: 0 23px;}
a.pic6 {background-image: url(/$wwp/../includes/commentit/im/bbquote.gif);background-position: 0 0;width: 21px;height: 23px;display: block;float:left;margin:0 3px 0 3px;}
a:hover.pic6 {background-position: 0 23px;}
a.pic7 {background-image: url(/$wwp/../includes/commentit/im/bbcolor.gif);background-position: 0 0;width: 21px;height: 23px;display: block;float:left; margin:0 3px 0 3px;}
a:hover.pic7 {background-position: 0 23px;}
a.pic10 {background-image: url(/$wwp/../includes/commentit/im/bbjustifyleft.gif);width: 24px;height: 23px;display: block;float:left;margin:0 0 0 3px;}
a:hover.pic10 {background-position: 0 23px;}
a.pic11 {background-image: url(/$wwp/../includes/commentit/im/bbjustifycenter.gif);background-position: 0 0;width: 23px;height: 23px;display: block;float:left;}
a:hover.pic11 {background-position: 0 23px;}
a.pic12 {background-image: url(/$wwp/../includes/commentit/im/bbjustifyright.gif);background-position: 0 0;width: 24px;height: 23px;display: block;float:left;}
a:hover.pic12 {background-position: 0 23px;}
a.pic13 {background-image: url(/$wwp/../includes/commentit/im/bbsmail.gif);background-position: 0 0;width: 21px;height: 23px;display: block;float:left;margin:0 3px 0 3px;}
...
$dex="DESC";
$edit=$_GET['edit'];
if ($_GET['onlyurl']) $zapcount="WHERE url='".mysql_real_escape_string($_GET['onlyurl'])."'";
$out=0;$countcomment=mysql_query("SELECT count(url) FROM `$table` $zapcount ");$out=mysql_result($countcomment,0);
?>
<div id="primary_nav">  
<ul>
...
if ($massparam['listz']<>0) {$rpp=$massparam['listz'];} else {$rpp=99999999;} 
...
if (($massparam['listz'])&&(!$treeview)) {
if (!empty($pages)){ $viewallpage .= $langcommentit['admin_page']."  ";}
############
$rad=3; 
if (empty($only)&&empty($onlyurl)) $link_sc='?nums';
...
$viewall.="<a href=?onlyurl=".$myrow['url'].">".$langcommentit['admin_viewonly']."</a> | ";
$viewall.="<a href=?repl=".$myrow['num']."&urlz=".str_replace('&','ZOZZ',$myrow['url'])."&level=".$repllevel.">".$langcommentit['admin_reply']."</a><br /><br />";
...
*/
$urlz=str_replace('ZOZZ','&',$urlz);
$urlz=str_replace(' ','%20',$urlz);
...
$query = "INSERT INTO `$table` (`num`, `url`, `name`, `comm`, `data`,`rootid`,`level`,`admincom`) VALUES (NULL, '".$urlz."', '-', '".mysql_real_escape_string($comment)."', '".$dataz."','".$repl."','".$level."','1');";
$sort=@mysql_query($query) or die ("$query");
...
<div class="gendiv">
<a href="#1">• <?php echo $langcommentit['title_bb'];?></a><br />
<a href="#2">• <?php echo $langcommentit['title_cut'];?></a><br />
<a href="#3">• <?php echo $langcommentit['title_mail'];?></a><br />
<a href="#4">• <?php echo $langcommentit['title_other'];?></a><br />
<a href="#5">• <?php echo $langcommentit['title_level'];?></a><br />
<a href="#6">• <?php echo $langcommentit['title_latt'];?></a><br />
<a href="#7">• <?php echo $langcommentit['title_rss'];?></a><br />
<a href="#8">• <?php echo $langcommentit['title_mat'];?></a><br />
<a href="#9">• <?php echo $langcommentit['title_rating'];?></a><br />
<a href="#10">• <?php echo $langcommentit['title_logiza'];?></a><br />
</div>
<br />
...
echo ''.$langcommentit[$par].'<br /><select name="'.$par.'" id="'.$par.'" size="1"><option value="0">'.$langcommentit['select_off'].'</option><option value="1">'.$langcommentit['select_on'].'</option></select>&nbsp;&nbsp;<img title="" alt="" src="../includes/commentit/im/'.$color.'" /><script>selectOptionByValue(document.getElementById(\''.$par.'\'),"'.$massparam[$par].'");</script>';
}
...
global $langcommentit,$massparam;
$color='enabled.gif';if ($massparam[$par]==0) {$color='disabled.gif';}
$ico='<img src="../includes/commentit/im/'.$par.'.png" border="0" />';
echo $ico.' '.$langcommentit[$par].'<br /><select name="'.$par.'" id="'.$par.'" size="1"><option value="0">'.$langcommentit['select_off'].'</option><option value="1">'.$langcommentit['select_on'].'</option></select>&nbsp;&nbsp;<img title="" alt="" src="../includes/commentit/im/'.$color.'" /><script>selectOptionByValue(document.getElementById(\''.$par.'\'),"'.$massparam[$par].'");</script>';
}
...
CommentiIt 5.2.5 Ajax &copy 2012
</div>
</div>
</body>
</html>
