<?php 
    ...
    header("content-type: application/x-javascript;charset=$codername");
?>
...
var textz2 = encodeURIComponent(document.getElementById("textz") && document.getElementById("textz").value || '');
var nick2 = document.getElementById("nick") && document.getElementById("nick").value || '';
var keystring2 = document.getElementById("keystringz") && document.getElementById("keystringz").value || '';
var urls2 = encodeURIComponent(document.getElementById("urls") && document.getElementById("urls").value || '');
var forms2 = document.getElementById("forms") && document.getElementById("forms").value || '';
var usmail2 = document.getElementById("usmail") && document.getElementById("usmail").value || '';
var idcomm2 = document.getElementById("idcomnow") && document.getElementById("idcomnow").value || '';
var toke2 = document.getElementById("token") && document.getElementById("token").value || '';
var usurl2 = encodeURIComponent(document.getElementById("usurl") && document.getElementById("usurl").value || '');
var products_id = document.forms.addcomm && document.forms.addcomm.elements.products_id && parseInt(document.forms.addcomm.elements.products_id.value) ? '&products_id=' + encodeURIComponent(parseInt(document.forms.addcomm.elements.products_id.value)) : '';
var mark = document.forms.addcomm && document.forms.addcomm.elements.mark && parseInt(document.forms.addcomm.elements.mark.value) ? '&mark=' + encodeURIComponent(parseInt(document.forms.addcomm.elements.mark.value)) : '';
var xmlString = "namenew="+nick2+"&comment="+textz2+"&url="+urls2+"&addcomment="+forms2+"&keystring="+keystring2+"&usmail="+usmail2+"&idcomnow="+idcomm2+"&usurl="+usurl2+"&tokenz="+toke2 + products_id + mark;
http_request.send(xmlString);
document.getElementById('tableDiv').style.display='';
if(document.getElementById('miniload')) document.getElementById('miniload').style.display='';
...
if(document.getElementById('miniload')) document.getElementById('miniload').style.display='none';
...
<?php // if ($massparam['sort']==1) echo 'location.replace("#commentitstart");';?>
	}
