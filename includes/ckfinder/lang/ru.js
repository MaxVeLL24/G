...
CKFinder.lang['ru'] =
{
	...
	// Flash Uploads
	UploadLabel			: 'Файлы для загрузки', // MISSING
	UploadTotalFiles	: 'Всего файлов:', // MISSING
	UploadTotalSize		: 'Общий размер:', // MISSING
	UploadAddFiles		: 'Добавить файлы', // MISSING
	UploadClearFiles	: 'Удалить файлы', // MISSING
	UploadCancel		: 'Отменить закачку', // MISSING
	UploadRemove		: 'Удалить', // MISSING
	UploadRemoveTip		: 'Удалить !f', // MISSING
	UploadUploaded		: 'Закачано !n%', // MISSING
	UploadProcessing	: 'Думаю...', // MISSING
