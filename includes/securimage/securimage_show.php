...
$img->image_width = 70;
$img->image_height = 26;
//$img->charset = 'йцукенгшщзхъэждлорпавыфячсмитьбю';
...
//$img->image_bg_color = new Securimage_Color("#ffe2f1");
$img->text_color = new Securimage_Color("#349ddb");
$img->text_transparency_percentage = 90; // 100 = completely transparent
$img->num_lines = 5;
