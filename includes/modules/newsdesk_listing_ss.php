...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
	<tr>
		<td style="color:#5a5a5a;">&nbsp;<?php echo $listing_split->display_count(TEXT_DISPLAY_NUMBER_OF_ARTICLES); ?>&nbsp;</td>
...
?>
	...
	<tr>
		<td style="border:1px solid #e0e0e0;background:#f5f5f5;border-radius:5px;">
...
if ( ($number_of_products/2) == floor($number_of_products/2) ) {
		...
		case 'NEWSDESK_STATUS':
			...
			. 'newsdesk_id=' . $listing_values['newsdesk_id']) . '">' . $listing_values['newsdesk_status'] . '</a>&nbsp;';
				break;
		case 'NEWSDESK_DATE_AVAILABLE':
			$lc_text = '<div style="background:white;border:1px solid #e0e0e0;margin:3px 0 3px 5px;;border-radius:3px;padding:2px 2px;"><a href="' . tep_href_link(FILENAME_NEWSDESK_INFO, ($newsPath ? 'newsPath=' . $newsPath . '&' : '') 
			. 'newsdesk_id=' . $listing_values['newsdesk_id']) . '">' . $listing_values['newsdesk_date_added'] . '</a></div>';
			break;
		case 'NEWSDESK_ARTICLE_NAME':
			$lc_text = '<div style="margin:5px 0 0 10px;"><a href="' . tep_href_link(FILENAME_NEWSDESK_INFO, ($newsPath ? 'newsPath=' . $newsPath . '&' : '') 
			. 'newsdesk_id=' . $listing_values['newsdesk_id']) . '">' . $listing_values['newsdesk_article_name'] . '</a></div>';
			break;
		case 'NEWSDESK_ARTICLE_SHORTTEXT':
			$lc_text = '&nbsp;<a href="' . tep_href_link(FILENAME_NEWSDESK_INFO, ($newsPath ? 'newsPath=' . $newsPath . '&' : '') 
