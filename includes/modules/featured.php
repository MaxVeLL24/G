...
<?php
 ...
 if(FEATURED_PRODUCTS_DISPLAY == true)
 {
  ...
  if ( (!isset($featured_products_category_id)) || ($featured_products_category_id == '0') ) {
    $info_box_contents[] = array('align' => 'left', 'text' => 'Обратите внимание');
  ...
  while ($featured_products = tep_db_fetch_array($featured_products_query)) {
    $num ++; 
      if ($num == 1) { 
       ...
       new infoBoxHeading4($info_box_contents, false, false, tep_href_link(FILENAME_FEATURED_PRODUCTS));}
      $featured_products['products_description'] = tep_get_products_info($featured_products['products_id']);
	...
	if ($featured_price = tep_get_products_special_price($featured_products['products_id'])) {
     ...
     $featured_products['specials_featured_products_price'] = tep_xppp_getproductprice($featured_products['products_id']); // Спец. цена
	  $info_box_contents[$row][$col] = array('align' => 'center',
                                       'params' => 'class="smallText" width="300" valign="top" ',
                                       'text' => '
		<table height="270" style="border-top: solid 1px #FEC2C2; border-left: solid 1px #FEC2C2;" class="smallText">
		<tr valign="top"><td height="30" align="center" class="smallText"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_products['products_id']) . '">
		' . $featured_products['products_name'] . '
		</a></td></tr>	
		<tr valign="middle"><td align="center" height="122" class="smallText"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_products['products_id']) . '">
		...
		<tr valign="top"><td align="center" style="padding:1px" class="smallText">' . strip_tags(substr($featured_products['products_description'], 0, 150)) . '...
		</td></tr>
		<tr><td align="center" class="smallText">' . $currencies->display_price($featured_products['specials_featured_products_price'], tep_get_tax_rate($featured_products['products_tax_class_id'])).'
</td></tr></table>');
    }
