...
// fix counted faqs
$listing_numrows_query = tep_db_query($listing_sql);
$listing_numrows = tep_db_num_rows($listing_numrows_query);
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
	<tr>
		<td class="smallText">&nbsp;
<?php
echo $listing_split->display_count($listing_numrows, MAX_DISPLAY_FAQDESK_SEARCH_RESULTS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_ARTICLES);
?>
		&nbsp;</td>
		<td align="right" class="smallText">&nbsp;
<?php
echo TEXT_RESULT_PAGE;
echo $listing_split->display_links($listing_numrows, MAX_DISPLAY_FAQDESK_SEARCH_RESULTS, MAX_DISPLAY_FAQDESK_PAGE_LINKS, $_GET['page'], tep_get_all_get_params(array('page', 'info', 'x', 'y')));
?>
		&nbsp;</td>
	</tr>
</table>
...
<?php
if ($listing_numrows > 0 && (FAQDESK_PREV_NEXT_BAR_LOCATION == '2' || FAQDESK_PREV_NEXT_BAR_LOCATION == '3')) {
?>
...
?>
		...
		<td align="right" class="smallText">&nbsp;
<?php
echo TEXT_RESULT_PAGE; ?> <?php echo $listing_split->display_links($listing_numrows, MAX_DISPLAY_FAQDESK_SEARCH_RESULTS, MAX_DISPLAY_FAQDESK_PAGE_LINKS, 
$_GET['page'], tep_get_all_get_params(array('page', 'info', 'x', 'y')));
?>
		&nbsp;</td>
	</tr>
</table>
