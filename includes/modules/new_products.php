...
<?php
 ...
 $info_box_contents = array();
  ...
  new infoBoxHeading3($info_box_contents, false, false, tep_href_link(FILENAME_PRODUCTS_NEW));
...
//    }
	...
	if ($new_price = tep_get_products_special_price($new_products['products_id'])) {
     ...
     $new_products['specials_new_products_price'] = tep_xppp_getproductprice($new_products['products_id']); // Спец. цена
	  $info_box_contents[$row][$col] = array('align' => 'center',
                                       'params' => 'class="smallText" style="border-left: solid 1px #cccccc;border-top: solid 1px #cccccc;" width="33%" valign="top"',
