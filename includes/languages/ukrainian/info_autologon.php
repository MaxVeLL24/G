...
*/
  ...
  define('SUB_HEADING_TITLE_1', 'Що таке \' Автоматична сесія \'?');
  define('SUB_HEADING_TITLE_2', 'Це безпечно?');
  define('SUB_HEADING_TITLE_3', 'І ...');
  ...
  define('SUB_HEADING_TEXT_2', 'Your password is only sent over the Internet using a secure link (SSL). Because of this secure link, the transmission of your password can not be intercepted. As an additional security feature only an encrypted version of your password is stored in the Cookie. If your computer is used by people other than yourself then we advise you <b> do not </b> to use the \'remember me \' feature. ');
