...
define('ACC_HISTORY_ORDER_NUM', 'Order number');
define('ACC_HISTORY_ORDER_DATE', 'Date');
define('ACC_HISTORY_ORDER_QUANTITY', 'Quantity');
define('ACC_HISTORY_ORDER_TOTAL', 'Total');
define('ACC_HISTORY_ORDER_STATUS', 'Order status');
define('ACC_HISTORY_ORDER_SHOW', 'Show');
