...
define('EMAIL_TEXT_SMS_ORDER', 'Your order №');
define('EMAIL_TEXT_SMS_DONE', ' accepted! Expect a call. Have a nice day! ');
define('EMAIL_TEXT_SMS_ADMIN', 'Hello! You have new order #');
