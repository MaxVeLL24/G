...
define('TEXT_MORE_INFORMATION', 'Для получения дополнительной информации Вы можете посетить <a href="%s" target="_blank"><u>эту страницу</u></a>.');
...
define('TEXT_XSELL_ARTICLES', 'По теме:');
