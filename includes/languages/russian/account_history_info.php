...
define('NAVBAR_TITLE_1', 'История заказов');
define('NAVBAR_TITLE_2', 'Информация о заказе №%d');

define('HEADING_TITLE', 'Информация о заказе №%d');

define('PAGE_TITLE', 'Информация о заказе №%d');
