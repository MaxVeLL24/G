...
*/
  ...
  define('MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION', 'Информация для оплаты:&nbsp;' . MODULE_PAYMENT_MONEYORDER_PAYTO . '<br><br>Почтовый адрес:<br>' .STORE_NAME_ADDRESS. '<br><br>' . 'Ваш заказ не будет отправлен пока мы не получим оплату.');
