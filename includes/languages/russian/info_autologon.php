...
define('SUB_HEADING_TITLE_1', 'Что такое \'Автоматическая сессия\'?');
define('SUB_HEADING_TITLE_2', 'Это безопасно?');
define('SUB_HEADING_TITLE_3', 'И...');
...
define('SUB_HEADING_TEXT_2', 'Your password is only sent over the Internet using a secure link (SSL). Because of this secure link, the transmission of your password cannot be intercepted. As an additional security feature only an encrypted version of your password is stored in the Cookie. If your computer is used by people other than yourself then we advise you <b> do not</b> to use the \'remember me\' feature.');
