 ...
 */
define('HEADING_PEREZVONIM', 'Оставьте заявку<br> мы Вам перезвоним');
...
define('CONTACT_US_SEND_ERROR', 'Не все требуемые поля были заполнены или они были заполнены с ошибками.');