        ...
        for ($i=2; $i<=$prices_num; $i++) {
              if($_POST['products_price_'.$i]){
                       foreach($_POST['products_price_'.$i] as $id => $new_price_list) {
                               $count_update++;
                               $item_updated[$id] = 'updated';
                               mysql_query("UPDATE " . TABLE_PRODUCTS . " SET products_price_$i=$new_price_list WHERE products_id=$id");
                       }
              }
        }
      ...
      <tr><td align="center">
           <table width="90%" cellspacing="0" cellpadding="0" border="1" bgcolor="#F3F9FB" bordercolor="#D1E7EF" height="100"><tr align="center"><td valign="middle">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr align="center">
                        <td class="smalltext"><?php echo tep_draw_form('row_by_page', FILENAME_PARSER, '', 'get'); echo tep_draw_hidden_field( 'manufacturer', $manufacturer); echo tep_draw_hidden_field( 'cPath', $current_category_id);?></td>
                        ...
                        <?php echo tep_draw_form('categorie', FILENAME_PARSER, '', 'get'); echo tep_draw_hidden_field( 'row_by_page', $row_by_page); echo tep_draw_hidden_field( 'manufacturer', $manufacturer); ?>
                        ...
                        <?php echo tep_draw_form('manufacturers', FILENAME_PARSER, '', 'get'); echo tep_draw_hidden_field( 'row_by_page', $row_by_page); echo tep_draw_hidden_field( 'cPath', $current_category_id);?>
                    ...
                    <tr align="center">
                        <td align="center">
                              <table border="0" cellspacing="0">
                               <form name="spec_price" <?php echo 'action="' . tep_href_link(FILENAME_PARSER, tep_get_all_get_params(array('action', 'info', 'pID')) . "action=calcul&page=$page&sort_by=$sort_by&cPath=$current_category_id&row_by_page=$row_by_page&manufacturer=$manufacturer" , 'NONSSL') . '"'; ?> method="post">
                                     <tr>
                                         ...
                                         } else echo '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_PARSER, "page=$page&sort_by=$sort_by&cPath=$current_category_id&row_by_page=$row_by_page&manufacturer=$manufacturer") . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>';?></td>
                                          <?php if(ACTIVATE_COMMERCIAL_MARGIN == 'true'){ echo '<td class="smalltext" align="center" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;' . tep_draw_checkbox_field('marge','yes','','no') . '&nbsp;' . TEXT_MARGE_INFO, tep_image(DIR_WS_IMAGES . 'icon_info.gif', TEXT_MARGE_INFO) . '</td>';}?>
                                     </tr>
                                     <tr>
                ...
                <td class="dataTableHeadingContent" align="left" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     ...
                     <?php if(DISPLAY_MODEL == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_model DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."&nbsp;</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">"  .TABLE_HEADING_MODEL ."</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">"  .TABLE_HEADING_MODEL ."</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_model ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >&nbsp;".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td colspan="2" class="dataTableHeadingContent" align="left" valign="middle">
 <table border="0" cellspacing="0" cellpadding="0">
                    <tr  class="dataTableHeadingRow">
                      <td  class="dataTableHeadingContent" align="right" valign="middle">
                <?php echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_price DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer) ."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a>" . TABLE_HEADING_PRICE . " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_price ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer) ."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a>"; ?> </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <td class="dataTableHeadingContent" align="left" valign="middle">
                      <table border="0" cellspacing="0" cellpadding="0">
                          <tr class="dataTableHeadingRow">
                              <td class="dataTableHeadingContent" align="left" valign="middle">
                                  <button type="button" name="rozetka_price_update_all">Обновить все</button>
                          </tr>
                      </table>
                  </td>
...
<td class="dataTableHeadingContent" align="left" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="left" valign="middle">
                     <?php echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=pd.products_name DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."&nbsp;</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_PRODUCTS . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=pd.products_name ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >&nbsp;".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="left" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="left" valign="middle">
                     <?php if(DISPLAY_STATUT == 'true')echo "<a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_status DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."&nbsp;</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\">" . TABLE_HEADING_STATUS . "<br>выкл. / вкл.</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_status ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >&nbsp;".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="left" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_WEIGHT == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_weight DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer) ."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_WEIGHT . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_weight ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer) ."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_QUANTITY == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_quantity DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_QUANTITY . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_quantity ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_SORT_ORDER == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_sort_order DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_PRODUCTS_SORT_ORDER . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_sort_order ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_ORDER_MIN == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_quantity_order_min DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_QUANTITY_ORDER_MIN . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_quantity_order_min ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_ORDER_UNITS == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_quantity_order_units DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_QUANTITY_ORDER_UNITS . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_quantity_order_units ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_IMAGE == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_image DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" .TABLE_HEADING_ROZETKA_LINK . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_image ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
                <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                     <td class="dataTableHeadingContent" align="right" valign="middle">
                     <?php if(DISPLAY_MANUFACTURER == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.manufacturers_id DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                     "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_MANUFACTURERS . "</td>" .
                     "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.manufacturers_id ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td>" ; ?>
                    </tr>
                  </table>
                </td>
 ...
 <td class="dataTableHeadingContent" align="center" valign="middle">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr class="dataTableHeadingRow">
                      <td class="dataTableHeadingContent" align="right" valign="middle">
                      <?php if(DISPLAY_TAX == 'true')echo " <a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_tax_class_id DESC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_down.gif', 'Desc')."</a></td> " .
                      "<td class=\"dataTableHeadingContent\" align=\"center\" valign=\"middle\">" . TABLE_HEADING_TAX . "</td>" .
                      "<td class=\"dataTableHeadingContent\" align=\"left\" valign=\"middle\"><a href=\"" . tep_href_link( FILENAME_PARSER, 'cPath='. $current_category_id .'&sort_by=p.products_tax_class_id ASC&page=' . $page.'&row_by_page=' . $row_by_page . '&manufacturer=' . $manufacturer)."\" >".tep_image(DIR_WS_IMAGES . 'icon_arrow_up.gif', 'Asc')."</a></td> " ; ?>
                    </tr>
                  </table>
                </td>
...
//// define the string parameters for good back preview product
     $origin = FILENAME_PARSER . "?info_back=$sort_by-$page-$current_category_id-$row_by_page-$manufacturer";
...
////  select categories
  ...
  if ($current_category_id == 0){
      if($manufacturer){
        $products_query_raw = "select p.products_id, ".$products_price_list.", p.products_image, p.products_model, pd.products_name, p.products_url_rozetka, p.products_rozetka_price, p.products_status, p.products_weight, p.products_quantity, p.products_quantity_order_min, p.products_quantity_order_units, p.products_sort_order, p.manufacturers_id, p.products_price, p.products_tax_class_id from  " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION .  " pd where p.products_id = pd.products_id and pd.language_id = '$languages_id' and p.manufacturers_id = " . $manufacturer . " $sort_by ";
      }else{
...
//// display infos per row
        ...
        if(DISPLAY_MODEL == 'true'){if(MODIFY_MODEL == 'true')echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"14\" name=\"product_new_model[".$products['products_id']."]\" value=\"".$products['products_model']."\"></td>\n";else echo "<td class=\"smallText\" align=\"left\">" . $products['products_model'] . "</td>\n";}else{ echo "<td class=\"smallText\" align=\"left\">";}
   ...
   // print_r($value);
    ...
    if ( in_array($products['products_id'],$specials_array)) {
            ...
            echo "<td class=\"smallText\" align=\"left\">&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" size=\"6\" name=\"product_new_price[".$products['products_id']."]\" value=\"".$products['products_price']."\" disabled >&nbsp;<a href=\"".tep_href_link (FILENAME_SPECIALS, 'sID='.$products['products_id'])."\">". tep_image(DIR_WS_IMAGES . 'icon_info.gif', TEXT_SPECIALS_PRODUCTS) ."</a>";
        } else {
            if ($flag_spec == 'true') {
                   echo "<td class=\"smallText\" align=\"left\">&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" size=\"6\" name=\"product_new_price[".$products['products_id']."]\" "; if(DISPLAY_TVA_UP == 'true'){ echo "onKeyUp=\"display_ttc('keyup', this.value" . ", " . $tax_rate['tax_rate'] . ", 1);\"";} echo " value=\"".$price ."\">".tep_draw_checkbox_field('update_price['.$products['products_id'].']','yes','checked','no')."";
            } else { echo "<td class=\"smallText\" align=\"left\">&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" size=\"6\" name=\"product_new_price[".$products['products_id']."]\" "; if(DISPLAY_TVA_UP == 'true'){ echo "onKeyUp=\"display_ttc('keyup', this.value" . ", " . $tax_rate['tax_rate'] . ", 1);\"";} echo " value=\"".$price ."\">".tep_draw_hidden_field('update_price['.$products['products_id'].']','yes'). "";}
        }

              $prices_num = tep_xppp_getpricesnum();
        for ($i=2; $i<=$prices_num; $i++) {
                     echo ' '.tep_draw_input_field("products_price_" . $i.'['.$products['products_id'].']', $products["products_price_" . $i], 'size=6');
        }
        echo '</td>';
    if(!empty($products['products_url_rozetka'])){
//        && ($htmlRozetka = file_get_html($products['products_url_rozetka']));
//        $priceRozetka = $htmlRozetka->find('meta[itemprop=price]');
//        $valueR = $priceRozetka[0]->content;

        $valueR = $products['products_rozetka_price'];
    } else {$valueR = 'empty';}
    //print_r($valueR);
    $colorR = 'style="color:red"';
    if ($valueR > $products['products_price']) $colorR = 'style="color:#00c100"';
    if ($valueR == 999999 || $valueR == 'empty' ) $colorR = 'style="color:black"';

    echo "<td class=\"rozetka_price\" align=\"left\" ".$colorR.">Rozetka.ua&nbsp;&nbsp;<input type=\"text\" size=\"6\" name=\"product_price_rozetka\" value=\"".$valueR."\" disabled ></td>";
    echo "<td class=\"smallText\" align=\"left\"><button type='button' name='product_rozetka_update' value='{$products['products_url_rozetka']}'>Обновить цену</button></td>";

//      $rozetka_update_query="UPDATE `products` SET `products_rozetka_price`='".$valueR."' WHERE `products_model`='".$products['products_model']."' ";
//      $rozetka_price_update = tep_db_query($rozetka_update_query);
 ...
 $products_price_list = tep_xppp_getpricelist("");
      ...
      $product_query = tep_db_query("select products_quantity, products_model, products_images, ". $products_price_list . ", products_date_available, products_weight, products_tax_class_id, products_quantity_order_min, products_quantity_order_units, products_sort_order, manufacturers_id from " . TABLE_PRODUCTS . " where products_id = '" . (int)$products_id . "'");
      ...
      print_r($product);
            ...
            tep_db_query("insert into " . TABLE_PRODUCTS . " (products_quantity, products_model, products_images, ". $products_price_list . ", products_date_added, products_date_available, products_weight, products_status, products_tax_class_id, products_quantity_order_min, products_quantity_order_units, products_sort_order, manufacturers_id) values ('" . tep_db_input($product['products_quantity']) . "', '" . tep_db_input($product['products_model']) . "', '" . tep_db_input($product['products_images']) . "', " . $products_instval . ",  now(), " . (empty($product['products_date_available']) ? "null" : "'" . tep_db_input($product['products_date_available']) . "'") . ", '" . tep_db_input($product['products_weight']) . "', '0', '" . (int)$product['products_tax_class_id'] . "', '" . (int)$product['products_quantity_order_min'] . "', '" . (int)$product['products_quantity_order_units'] . "', '" . (int)$product['products_sort_order'] . "', '" . (int)$product['manufacturers_id'] . "')");
            //TotalB2B end
     */

        if(MODIFY_NAME == 'true')echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"50\" name=\"product_new_name[".$products['products_id']."]\" value=\"".tep_output_string(stripslashes($products['products_name']))."\"></td>\n";
        else echo "<td class=\"smallText\" align=\"left\">".$products['products_name']."</td>\n";

//// Product status radio button
        if(DISPLAY_STATUT == 'true'){
            if ($products['products_status'] == '1') {
             echo "<td class=\"smallText\" align=\"left\"><input  type=\"radio\" name=\"product_new_status[".$products['products_id']."]\" value=\"0\" ><input type=\"radio\" name=\"product_new_status[".$products['products_id']."]\" value=\"1\" checked ></td>\n";
            } else {
             echo "<td class=\"smallText\" align=\"left\"><input type=\"radio\" style=\"background-color: #EEEEEE\" name=\"product_new_status[".$products['products_id']."]\" value=\"0\" checked ><input type=\"radio\" style=\"background-color: #EEEEEE\" name=\"product_new_status[".$products['products_id']."]\" value=\"1\"></td>\n";
            }
        }else{
        ...
        if(DISPLAY_QUANTITY == 'true')echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"3\" name=\"product_new_quantity[".$products['products_id']."]\" value=\"".$products['products_quantity']."\"></td>\n";else echo "<td class=\"smallText\" align=\"left\"></td>";
        if(DISPLAY_SORT_ORDER == 'true')echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"3\" name=\"product_new_sort_order[".$products['products_id']."]\" value=\"".$products['products_sort_order']."\"></td>\n";else echo "<td class=\"smallText\" align=\"left\"></td>";
        if(DISPLAY_ORDER_MIN == 'true')echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"3\" name=\"product_new_quantity_order_min[".$products['products_id']."]\" value=\"".$products['products_quantity_order_min']."\"></td>\n";else echo "<td class=\"smallText\" align=\"left\"></td>";
        if(DISPLAY_ORDER_UNITS == 'true')echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"3\" name=\"product_new_quantity_order_units[".$products['products_id']."]\" value=\"".$products['products_quantity_order_units']."\"></td>\n";else echo "<td class=\"smallText\" align=\"left\"></td>";
        echo "<td class=\"smallText\" align=\"left\"><input type=\"text\" size=\"25\" name=\"product_url_rozetka[".$products['products_id']."]\" value=\"".$products['products_url_rozetka']."\"></td>\n";
        if(DISPLAY_MANUFACTURER == 'true'){if(MODIFY_MANUFACTURER == 'true')echo "<td class=\"smallText\" align=\"left\">".tep_draw_pull_down_menu("product_new_manufacturer[".$products['products_id']."]\"", $manufacturers_array, $products['manufacturers_id'])."</td>\n";else echo "<td class=\"smallText\" align=\"left\">" . $manufacturer['manufacturers_name'] . "</td>";}else{ echo "<td class=\"smallText\" align=\"center\"></td>";}
//// check specials
//        if ( in_array($products['products_id'],$specials_array)) {
...
<?php
        ...
        echo '<a href="javascript:window.print()">' . tep_image_button('button_print.gif', PRINT_TEXT) . '</a>&nbsp;&nbsp;';
          ...
          echo '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_PARSER,"row_by_page=$row_by_page") . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>';
?></td>
</tr>
</form>
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                ...
                <td class="smallText" align="right"><?php echo $products_split->display_links($products_query_numrows, MAX_DISPLAY_ROW_BY_PAGE, MAX_DISPLAY_PAGE_LINKS, $split_page, '&cPath='. $current_category_id . '&manufacturer='. $manufacturer .'&sort_by='.$sort_by . '&row_by_page=' . $row_by_page); ?></td>
            </table></td>
          </tr>
        </table></td>
      </tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('button[name=product_rozetka_update]').click(function (e) {
            var rozetkahtml = $(this).val();
            $.ajax({
                url: "parser_ajax.php",
                type: "post",
                data: {
                    'product_rozetka_update': rozetkahtml
                },
                success: function (response) {
                    if (response) {
                         console.log(response);
                        var par = $(e.target).parents()[1];
                        $(par).find('td.rozetka_price input').val(response + '.0000');
                        $(par).find('td.rozetka_price input').css({"background-color": "greenyellow"});
                    }
                    else {
                       console.log(response);
                    }
        ...
        $('button[name=rozetka_price_update_all]').click(function (e) {
            var buttons = $('button[name=product_rozetka_update]');
