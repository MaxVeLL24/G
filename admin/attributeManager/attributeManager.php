...
<!-- ----- -->
	...
	?>
          ...
          <?php echo tep_draw_input_field("price_$optionValueId",$optionValueInfo['price'],' style="margin:2px 3px;padding:1px;" id="price_'.$optionValueId.'" size="7" onfocus="amF(this)" onblur="amB(this)" onChange="return amUpdate(\''.$optionId.'\',\''.$optionValueId.'\',\'price\');"'); ?>
          <?php echo tep_draw_input_field("pa_qty_$optionValueId",$optionValueInfo['pa_qty'],' style="margin:2px 0 2px 3px;padding:1px;width:20px;" id="pa_qty_'.$optionValueId.'" onfocus="amF(this)" onblur="amB(this)" onChange="return amUpdate(\''.$optionId.'\',\''.$optionValueId.'\',\'pa_qty\');"'); ?>
          <small>шт.</small>
...
<!-- ----- -->
	...
	<table border="0"  cellpadding="0" cellspacing="0">
        ...
        <?php echo tep_draw_hidden_field('newpa_qty','1','size="4" id="newpa_qty"'); ?>
			</td>
<?php
