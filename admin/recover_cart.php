...
<form method=post action=<?php echo $PHP_SELF; ?>>
            ...
            <tr class="dataTableHeadingRow">
              ...
              <td class="dataTableHeadingContent" align="left"  colspan="1"  width="5%" nowrap><?php echo TABLE_HEADING_PRICE; ?></td>
              <td class="dataTableHeadingContent" align="right"  colspan="1" width="10%" nowrap><?php echo TABLE_HEADING_TOTAL; ?></td>
            </tr>
...
//
  ...
  echo $cline;
 echo "<tr><td colspan=8><b>". PSMSG ."</b><br>". tep_draw_textarea_field('message', 'soft', '80', '5') ."<br>" . tep_draw_selection_field('submit_button', 'submit', TEXT_SEND_EMAIL) . "</td></tr>";
?>
 </form>
<?php }
//
