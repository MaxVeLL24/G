          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent"><?php echo PRODUCTS_MULTI_ITEM5; ?></td>
...
?>
                <td class="dataTableContent" width="40px" align="center"><input type="checkbox" name="choose[]" value="<?php echo $products['products_id']; ?>" id="checkbox_choose_<?php echo $products_count; ?>" <?php if($checkall==1) { echo 'checked'; } ?>></td>
                <td class="dataTableContent" width="50px" align="center"><?php echo tep_info_image($products['products_image'], $products['products_name'], 30, 30); ?></td>
              ...
              <tr>
                <td colspan="7"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <?php echo PRODUCTS_MULTI_ITEM1; ?><input type="radio" name="action" value="move_product_confirm" id="move_product_confirm">
                    <?php echo PRODUCTS_MULTI_ITEM2; ?><input type="radio" name="action" value="copy_to_confirm" id="copy_to_confirm" align="bottom">
                    <?php echo PRODUCTS_MULTI_ITEM3; ?><input type="radio" name="action" value="link_to_confirm" id="link_to_confirm" checked>
                  ...
                  <tr>
                    ...
                    <?php echo PRODUCTS_MULTI_ITEM4; ?><input type="radio" name="action" value="delete_product_confirm" id="delete_product_confirm">
      ...
      default:
        if ($rows > 0) {
          if (is_object($cInfo)) { // category info box contents
            ...
            $contents[] = array('text' => '<br>' . TEXT_PRODUCTS_AVERAGE_RATING1 . ' ' . number_format($pInfo->average_rating, 2) . '%');
          }
