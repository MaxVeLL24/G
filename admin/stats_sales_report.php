...
?>
                    <tr class="dataTableRow">
                      <td class="dataTableContent" width=93% align=right><?php echo '<b>'. $summary1 . ' </b>' ?></td>
                      <td class="dataTableContent" width=7% align=right><?php echo $currencies->format($sum / $report->size) ?></td>
                    </tr>
<?php } ?>
                    <tr class="dataTableRow">
                      <td class="dataTableContent" width=93% align=right><?php echo '<b>'. $summary2 . ' </b>' ?></td>
                      <td class="dataTableContent" width=7% align=right><?php echo $currencies->format($sum) ?></td>
                    </tr>
                  </table>
