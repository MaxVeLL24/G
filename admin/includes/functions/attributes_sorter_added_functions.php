          ...
          if (!$skip_it) {
            if ($check_attribute['products_id']) {
              ...
              $sql_data_array = array(
                ...
                'pa_imgs' => tep_db_prepare_input($products_copy_from['pa_imgs']),
...
// , attributes_default, attributes_qty_prices_onetime, attributes_discounted
			  ...
			  tep_db_query("insert into " . TABLE_PRODUCTS_ATTRIBUTES . " ( products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix, products_options_sort_order, pa_imgs, pa_qty) values ('', '" . $products_id_to . "', '" . $products_copy_from['options_id'] . "', '" . $products_copy_from['options_values_id'] . "', '" . $products_copy_from['options_values_price'] . "', '" . $products_copy_from['price_prefix'] . "', '" . $products_copy_from['products_options_sort_order'] ."', '".$products_copy_from['pa_imgs']."', '".$products_copy_from['pa_qty']."')");
            }
