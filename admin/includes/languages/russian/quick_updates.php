...
define('TABLE_HEADING_QUANTITY_ORDER_MIN', 'Минимум<br>для заказа');
define('TABLE_HEADING_QUANTITY_ORDER_UNITS', 'Шаг');
define('TABLE_HEADING_PRODUCTS_SORT_ORDER', 'Порядок<br>сортировки');
define('TABLE_HEADING_STATUS', 'Статус');
define('TABLE_HEADING_STATUS_ON', 'Вкл.');
define('TABLE_HEADING_STATUS_OFF', 'Выкл.');
define('TABLE_HEADING_MANUFACTURERS', 'Производитель');
define('TABLE_HEADING_IMAGE', 'Изображение');
define('TABLE_HEADING_LABEL_1', 'TOP');
define('TABLE_HEADING_LABEL_2', 'NEW');
define('TABLE_HEADING_LABEL_3', 'Акция');
