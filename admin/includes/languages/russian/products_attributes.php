...
define('TABLE_HEADING_SORT_ORDER', 'П-дк. сорт-ки.');
define('TABLE_HEADING_EXTRA_DATA', 'Доп. данные');
define('TABLE_HEADING_PHOTO', 'Фото/файл');
define('TEXT_SAVE_BEFORE_UPLOAD', 'Загрузка файла станет доступна после сохранения.');
