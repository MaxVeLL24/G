...
define('TABLE_HEADING_EXTRA_DATA', 'Extra Data');
define('TABLE_HEADING_PHOTO', 'File/Image');
define('TEXT_SAVE_BEFORE_UPLOAD', 'File uploading will be available after saving.');
...
define('TABLE_HEADING_OPT_CONDITION', 'Condition');
define('TEXT_OPT_CONDITION_AND', 'AND');
define('TEXT_OPT_CONDITION_OR', 'OR');
