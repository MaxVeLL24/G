...
define('EMAIL_TEXT_STATUS_UPDATE', 'Thank you so much for your order with us!' . '<br><br>' . 'The status of your order has been updated.' . '<br><br>' . 'New status: %s' . '<br><br>');
define('EMAIL_TEXT_STATUS_UPDATE2', 'If you have questions, please reply to this email.' . '<br><br>' . 'With warm regards from your friends at the ' . STORE_NAME . '<br>');
define('EMAIL_TEXT_COMMENTS_UPDATE', 'Here are the comments for your order:' . '<br><br>%s<br><br>');
