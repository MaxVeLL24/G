...
define('PAGE_HEADER', 'Products import/export');
define('TEXT_INSERT', 'Insert');
define('IMPORT_HEADER_TEXT', 'Import');
define('EXPORT_HEADER_TEXT', 'Export');
define('TEXT_CREATE', 'Create');
define('TEXT_SORT', 'Sort');

define('DOWNLOAD_SELECT_DOWNLOAD_OPTION_TEXT', 'Download');
define('DOWNLOAD_SELECT_CREATE_AND_DOWNLOAD_OPTION_TEXT', 'Create and download');
define('DOWNLOAD_SELECT_CREATE_TEMPORARY_FILE_OPTION_TEXT', 'Create in temporary folder');

define('DOWNLOAD_TYPE_SELECT_FULL_OPTION_TEXT', 'Full');
define('DOWNLOAD_TYPE_SELECT_PRICE_AND_QUANTITY_OPTION_TEXT', 'Price and quantity');
define('DOWNLOAD_TYPE_SELECT_CATEGORIES_OPTION_TEXT', 'Categories');
define('DOWNLOAD_TYPE_SELECT_ATTRIBUTES_OPTION_TEXT', 'Attributes');
define('DOWNLOAD_TYPE_SELECT_FROOGLE_OPTION_TEXT', 'Froogle');

define('TEXT_PRODUCT_CODE_IS_ALWAYS_THERE', ' file (product code is always there).');

define('CATEGORY_FILTER_SELECT_DEFAULT_OPTION_TEXT', '- Category -');

define('MANUFACTURER_FILTER_SELECT_DEFAULT_OPTION_TEXT', '- Manufacturer -');

define('STATUS_FILTER_SELECT_DEFAULT_OPTION_TEXT', '- Status -');
define('STATUS_FILTER_SELECT_ENABLED_OPTION_TEXT', 'Enabled');
define('STATUS_FILTER_SELECT_DISABLED_OPTION_TEXT', 'Disabled');