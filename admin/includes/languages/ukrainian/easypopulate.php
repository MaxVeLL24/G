...
define('PAGE_HEADER', 'Импорт/экспорт товаров');
define('TEXT_INSERT', 'Вставить');
define('IMPORT_HEADER_TEXT', 'Импорт');
define('EXPORT_HEADER_TEXT', 'Экспорт');
define('TEXT_CREATE', 'Создать');
define('TEXT_SORT', 'Сортировка');

define('DOWNLOAD_SELECT_DOWNLOAD_OPTION_TEXT', 'Скачать на лету');
define('DOWNLOAD_SELECT_CREATE_AND_DOWNLOAD_OPTION_TEXT', 'Создать и скачать');
define('DOWNLOAD_SELECT_CREATE_TEMPORARY_FILE_OPTION_TEXT', 'Создать в временной папке');

define('DOWNLOAD_TYPE_SELECT_FULL_OPTION_TEXT', 'Все');
define('DOWNLOAD_TYPE_SELECT_PRICE_AND_QUANTITY_OPTION_TEXT', 'Цена/Количество');
define('DOWNLOAD_TYPE_SELECT_CATEGORIES_OPTION_TEXT', 'Категории');
define('DOWNLOAD_TYPE_SELECT_ATTRIBUTES_OPTION_TEXT', 'Аттрибуты');
define('DOWNLOAD_TYPE_SELECT_FROOGLE_OPTION_TEXT', 'Froogle');

define('TEXT_PRODUCT_CODE_IS_ALWAYS_THERE', ' файл (код товара всегда есть).');

define('CATEGORY_FILTER_SELECT_DEFAULT_OPTION_TEXT', '- категория -');

define('MANUFACTURER_FILTER_SELECT_DEFAULT_OPTION_TEXT', '- производитель -');

define('STATUS_FILTER_SELECT_DEFAULT_OPTION_TEXT', '- статус -');
define('STATUS_FILTER_SELECT_ENABLED_OPTION_TEXT', 'Включено');
define('STATUS_FILTER_SELECT_DISABLED_OPTION_TEXT', 'Выключено');