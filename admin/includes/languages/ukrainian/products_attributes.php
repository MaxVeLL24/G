...
define('TABLE_HEADING_SORT_ORDER', 'П-док. сорутвання');
define('TABLE_HEADING_EXTRA_DATA', 'Додаткові дані');
define('TABLE_HEADING_PHOTO', 'Фото/файл');
define('TEXT_SAVE_BEFORE_UPLOAD', 'Завантаження файлу стане можливе після збереження.');
...
define('TABLE_HEADING_OPT_CONDITION', 'Условие опции');
define('TEXT_OPT_CONDITION_AND', 'И');
define('TEXT_OPT_CONDITION_OR', 'ИЛИ');
